import 'package:al_maafer/day_night_time_picker/src/day_night_timepicker_android.dart';
import 'package:al_maafer/day_night_time_picker/src/day_night_timepicker_ios.dart';
...
import 'package:al_maafer/day_night_time_picker/src/ampm.dart';
import 'package:al_maafer/day_night_time_picker/src/common/action_buttons.dart';
import 'package:al_maafer/day_night_time_picker/src/common/display_value.dart';
import 'package:al_maafer/day_night_time_picker/src/common/filter_wrapper.dart';
import 'package:al_maafer/day_night_time_picker/src/common/wrapper_container.dart';
import 'package:al_maafer/day_night_time_picker/src/common/wrapper_dialog.dart';
import 'package:al_maafer/day_night_time_picker/src/daynight_banner.dart';
import 'package:al_maafer/day_night_time_picker/src/utils.dart';
...
class DayNightTimePickerController extends GetxController {
...
dynamic showPicker({
  ...
  TextStyle okStyle = const TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
  TextStyle cancelStyle = const TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
  TextStyle? hmsStyle,
  ...
  final controller = Get.put(DayNightTimePickerController());
