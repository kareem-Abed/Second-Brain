...
import 'package:al_maafer/appflowy_board/src/widgets/board_group/group_data.dart';
...
class AppFlowyBoardController extends ChangeNotifier
  ...
  if (toGroupController.items.length > toGroupIndex) {
    if (toGroupController.items[toGroupIndex] is PhantomGroupItem) {
      toGroupController.replace(toGroupIndex, fromGroupItem);
    } else {
      toGroupController.insert(toGroupIndex, fromGroupItem);
    }
    onMoveGroupItemToGroup?.call(
      fromGroupId,
      fromGroupIndex,
    ...
    toGroupController.add(fromGroupItem);
    onMoveGroupItemToGroup?.call(
      fromGroupId,
      fromGroupIndex,
      toGroupId,
